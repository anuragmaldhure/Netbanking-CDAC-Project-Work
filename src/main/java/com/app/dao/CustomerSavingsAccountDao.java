...
public interface CustomerSavingsAccountDao extends JpaRepository<CustomerSavingAccounts, Long> {
	...
	CustomerSavingAccounts findByCustomerDetails_CustomerId(Long customerId);
